...
Transport.create!(transport_type: 'Rollers', description: 'Des patins pour foncer sur les quais !', picture:'https://images.pexels.com/photos/3779669/pexels-photo-3779669.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', localization:'Lyon', user_id: 1 )
Transport.create!(transport_type: 'Velo éléctrique', description: 'un vélo ou un scooter ? venez le tester !', picture:'https://images.pexels.com/photos/2130611/pexels-photo-2130611.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940' , localization: 'Bordeaux' , user_id: 1 )
Transport.create!(transport_type: 'Rollers', description: 'Ca roule ma poule', picture:'https://images.pexels.com/photos/2005992/pexels-photo-2005992.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940' , localization:'Paris', user_id: 2 )
